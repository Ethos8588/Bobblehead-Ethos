  ...
  const res = await fetchImpl(ANTHROPIC_URL, {
    ...
    body: JSON.stringify({
      ...
      system:
        ...
        buildCategoryList(),
      // No stop_sequences here: the Anthropic API rejects any stop sequence
      // made only of whitespace, and max_tokens plus the assistant prefill
      // below already keep the answer to a single word.
      messages: [
